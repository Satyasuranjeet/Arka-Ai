...
- UI changes (React frontend) and backend logic (Python API/background tasks)
- Real-time client state and database persistence
...
- `src/components/ui/*` (shadcn/ui or reusable UI components adapted for Vite/React)
...
- System architecture or boundaries (React frontend vs. Python backend)
- Storage model decisions or database schemas
...
1. The current unit works end to end across the React frontend and Python backend within its defined scope.
