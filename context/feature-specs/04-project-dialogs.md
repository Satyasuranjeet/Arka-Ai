...
Create a dedicated custom React hook (e.g., `src/hooks/useProjectDialogs.js`) to manage:
...
Use mock JavaScript project data only. Do not add Python API calls or persistence.

## Check When Done

- sidebar actions are wired
- slug preview works
- no JavaScript compilation or React runtime errors (replacing TypeScript verification)
- no lint errors